  ...
  <div>
      ...
      <div class="container">
        <div class="logo float-left">
          ...
          <a href="#intro" class="scrollto">
            <img src="assets/img/logo-light.png" alt="" class="img-fluid" />
          </a>
        </div>
    ...
    <section id="intro" class="clearfix">
      <div class="container-fluid">
        <div class="owl-carousel home-carousel wow fadeInUp">
                  ...
                  >
                    <div class="tab-pane-wrap">
                      <div class="pane-content">
                        ...
                        elit. Perferendis quod blanditiis consequatur voluptatum
                        earum pariatur voluptatibus magni odit itaque delectus
                        quisquam asperiores aut voluptatem, accusantium
                        consectetur, sapiente ex nisi tempora!
                      </div>
                      <div class="pane-img">
                        <!-- add image here -->
                        <img src="" />
